...
if __name__ == '__main__':
    ...
    if args.epi:
        ...
        epi_raw = pd.read_json(os.path.join(os.path.dirname(__file__), "../../data/raw/recipes_raw_epi.json"))
        if args.v:
            print(epi_raw.head())
        ...
        epi_data.to_pickle(os.path.join(os.path.dirname(__file__), "../../data/interim/epi_data.pickle"))
        epi_ingredients.to_pickle(os.path.join(os.path.dirname(__file__), "../../data/interim/epi_ingredients.pickle"))
